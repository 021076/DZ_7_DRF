    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method',
                 models.CharField(choices=[('Cash', 'Наличные'), ('Transfer', 'Перевод на счет')], max_length=15,
                                  verbose_name='Способ оплаты')),
                ('course_paid',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='materials.learningcourse',
